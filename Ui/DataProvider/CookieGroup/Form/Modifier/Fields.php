...
namespace Deloitte\CookieConsent\Ui\DataProvider\CookieGroup\Form\Modifier;
...
use Deloitte\CookieConsent\Helper\AttributesHelper;
use Deloitte\CookieConsent\Helper\UiComponentHelper;
...
class Fields implements ModifierInterface
{
    ...
    public function modifyData(array $data)
    {
        ...
        $submitUrl = $this->urlBuilder->getUrl('deloitte_cookie_consent/cookiegroup/save', $parameters);
    ...
    public function getModel(): CookieGroup
    {
        ...
        $model = $this->registry->registry('deloitte_cookie_consent_cookie_group');
