...
namespace Deloitte\CookieConsent\ViewModel;

use Magento\Framework\Stdlib\CookieManagerInterface;
use Magento\Framework\View\Element\Block\ArgumentInterface;
use Magento\Store\Model\StoreManagerInterface;
use Deloitte\CookieConsent\Api\Data\CookieGroupInterface;
use Deloitte\CookieConsent\Config\CookieConsentConfig;
use Deloitte\CookieConsent\Model\ResourceModel\CookieGroup\CollectionFactory;

class Cookie implements ArgumentInterface
{
    const IDENTIFIER_COOKIE_POLICY_CONTENT = 'deloitte_cookie_consent_cookie_policy_content';
    const IDENTIFIER_PRIVACY_POLICY_CONTENT = 'deloitte_cookie_consent_privacy_policy_content';
