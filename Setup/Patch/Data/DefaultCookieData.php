...
use Deloitte\CookieConsent\Api\CookieGroupRepositoryInterface;
use Deloitte\CookieConsent\Api\Data\CookieGroupInterface;
use Deloitte\CookieConsent\Model\CookieGroupFactory;
...
class DefaultCookieData implements DataPatchInterface
{
    ...
    private function createDefaultPage(): void
    {
        ...
        $page->setContent('<p>{{widget type="Deloitte\CookieConsent\Block\Widget\Overview"}}</p>' . PHP_EOL .
            '<p>{{widget type="Deloitte\CookieConsent\Block\Widget\Preferences\Button" preferences_button_type="0"}}</p>');
    ...
    private function createDefaultBlocks(): void
    {
        ...
        $cookiePolicyBlock->setIdentifier('deloitte_cookie_consent_cookie_policy_content');
        ...
        $privacyPolicyBlock->setIdentifier('deloitte_cookie_consent_privacy_policy_content');
