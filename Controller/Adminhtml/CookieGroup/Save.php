...
namespace Deloitte\CookieConsent\Controller\Adminhtml\CookieGroup;
...
use Deloitte\CookieConsent\Model\CookieGroup;
use Deloitte\CookieConsent\Model\CookieGroupFactory;

class Save extends Action
{
    const ADMIN_RESOURCE = 'Deloitte_CookieConsent::CookieGroup_save';
    ...
    public function execute()
    {
        ...
        try {
            ...
            $this->dataPersistor->clear('deloitte_cookie_consent_cookie_group');
        ...
        $this->dataPersistor->set('deloitte_cookie_consent_cookie_group', $data);
